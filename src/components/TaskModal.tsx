          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2">
              <input
                ...
                className="px-3.5 py-2 bg-sunken border border-line rounded-xl text-xs sm:text-sm font-medium text-ink focus:outline-hidden focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 dark:focus:border-indigo-400 focus:bg-surface transition-all cursor-pointer flex-1 sm:max-w-xs"
              />
              <div className="flex items-center gap-1.5 text-[11px] flex-wrap">
                <button
                  type="button"
                  onClick={() => setQuickDate(0)}
                  className="px-2.5 py-1 bg-slate-100 dark:bg-white/[0.05] hover:bg-slate-200 dark:hover:bg-white/[0.1] text-ink border border-transparent dark:border-white/[0.05] rounded-lg font-medium cursor-pointer transition-colors"
                >
                  Hoje
                </button>
                <button
